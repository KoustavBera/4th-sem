...
public class StringBuffer1 {
	...
	public static void main(String[] args) {
		// initial content "HelloSection2K3"
		StringBuffer sb=new StringBuffer("HelloSection2K3");
		...
		//4.Delete a substring from the StringBuiolder
		sb.delete(8, 14);
		...
		int indexOfSection=sb.indexOf("Section");
		System.out.println("Index of 'Section': "+indexOfSection);
